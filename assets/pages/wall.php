        ...
        <div class="col-8">
            <div class="card mt-4">
                <div class="card-title d-flex justify-content-between  align-items-center">
                    ...
                    <div class="d-flex align-items-center p-2">
                        <img src="assets/images/profile.jpg" alt="" height="30" class="rounded-circle border">&nbsp;&nbsp;
                    </div>
                    <div class="p-2">
                        <i class="bi bi-three-dots-vertical"></i>
                    </div>
                </div>
                <img src="/images/post2.jpg" class="" alt="...">
            ...
            <div class="card mt-4">
                <div class="card-title d-flex justify-content-between  align-items-center">
                    ...
                    <div class="d-flex align-items-center p-2">
                        <img src="assets/images/profile.jpg" alt="" height="30" class="rounded-circle border">&nbsp;&nbsp;Prakhar
                    </div>
                    <div class="p-2">
                        <i class="bi bi-three-dots-vertical"></i>
                    </div>
                </div>
                <img src="/images/post3.png" class="" alt="...">
                <h4 style="font-size: x-larger" class="p-2 border-bottom"><i class="bi bi-heart"></i>&nbsp;&nbsp;<i
                        class="bi bi-chat-left"></i>
                </h4>
                <div class="card-body">
            ...
            <div class="card mt-4">
                ...
                <img src="/images/post.jpg" class="" alt="...">
                <h4 style="font-size: x-larger" class="p-2 border-bottom"><i class="bi bi-heart"></i>&nbsp;&nbsp;<i
                        class="bi bi-chat-left"></i>
                </h4>
                <div class="card-body">
            ...
            <div class="card mt-4">
                ...
                <img src="/images/post5.jpg" class="" alt="...">
                <h4 style="font-size: x-larger" class="p-2 border-bottom"><i class="bi bi-heart"></i>&nbsp;&nbsp;<i
                        class="bi bi-chat-left"></i>
                </h4>
                <div class="card-body">
        ...
        <div class="col-4 mt-4 p-3">
            <div class="d-flex align-items-center p-2">
                ...
                <div class="d-flex flex-column justify-content-center align-items-center">
                    <h6 style="margin: 0px;"><?=$user['first_name']?></h6>
            ...
            <div>
                ...
                <div class="d-flex justify-content-between">
                    <div class="d-flex align-items-center p-2">
                        <div><img src="assets/images/profile2.jpg" alt="" height="40" class="rounded-circle border">
                        </div>
                        <div>&nbsp;&nbsp;</div>
                    ...
                    <div class="d-flex align-items-center">
                        <button name="primarybutton" class="btn btn-sm btn-primary">Follow</button>
                ...
                <div class="d-flex justify-content-between">
                    <div class="d-flex align-items-center p-2">
                        <div><img src="/images/profile7.jpg" alt="" height="40" class="rounded-circle border">
                        </div>
                        <div>&nbsp;&nbsp;</div>
                        <div class="d-flex flex-column justify-content-center">
                ...
                <div class="d-flex justify-content-between">
                    <div class="d-flex align-items-center p-2">
                        <div><img src="/images/profile8.jpg" alt="" height="40" class="rounded-circle border">
                        </div>
                        <div>&nbsp;&nbsp;</div>
                        <div class="d-flex flex-column justify-content-center">
                    ...
                    <div class="d-flex align-items-center">
                        <button name="primarybutton" class="btn btn-sm btn-primary" style="">Follow</button>
